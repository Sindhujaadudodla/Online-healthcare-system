...
m-Healthcare Cloud Computing System</center> </span><small></small></h1>
   ...
   <h2><b>Access Control Screen</b></h2>
	...
	if(res != null){
		out.println("<center><font face=verdana color=red>"+res+"</center></font>");
			...
			<tr><th><font size="3" color="black">UserName</th><th><font size="3" color="black">User Type</th>
			...
			<th><font size="3" color="black">Speciality</th><th><font size="3" color="black">Hospital ID</th>
			<th><font size="3" color="black">Access Control</th>
			<tr>
	<%
	...
	<td><a href="AccessControl?t1=<%=rs.getString(1)%>&t2=<%=rs.getString(6)%>&t3=<%=rs.getString(7)%>&t4=<%=rs.getString(8)%>"><font size="3" color="black">Click Here</a></td>
	<%}%>
	</tr>
	</table>
	</body>
