...
public class Chart extends ApplicationFrame{
	...
	static long memory;
	static String title;
public Chart(String paramString,long r,long m){
	super(paramString);
	runtime = r;
	memory = m;
...
private static CategoryDataset createDataset(){
	...
	localDefaultCategoryDataset.addValue(runtime,"Execution Time","Execution Time");
	localDefaultCategoryDataset.addValue(memory,"Memory Usage","Memory Usage");
...
private static JFreeChart createChart(CategoryDataset paramCategoryDataset){
	JFreeChart localJFreeChart = ChartFactory.createBarChart(title,"Computation & Storage Chart", "Value (M.S,Kilo Bytes)", paramCategoryDataset, PlotOrientation.VERTICAL, true, true, false);
